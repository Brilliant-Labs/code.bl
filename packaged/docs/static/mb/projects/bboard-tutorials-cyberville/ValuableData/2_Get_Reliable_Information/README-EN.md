...
This activity is related to __Phishing 🎣__, and our source of information is privided by ![RedHat](https://github.com/Brilliant-Labs/code.bl/blob/code_alpha/packaged/docs/static/mb/projects/bboard-tutorials-cyberville/ValuableData/2_Get_Reliable_Information/RedHat.png?raw=true "RedHat") the 🔴 🎩 __Red Hat__ friend.
## Activity
__*Let's start!!!*__
## __🧑‍🏫 Teachers:__
...
## Code Example
You can download the .hex file for this activity by clicking [__⬇️ Here__](https://www.brilliantlabs.ca/documents/cybersec/M2-Water-Plant-Red-Hat.hex), then drag an drop it anywhere on the Workspace. 
<!--
