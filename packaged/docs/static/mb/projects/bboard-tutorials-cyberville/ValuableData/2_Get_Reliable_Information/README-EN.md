...
This activity is related to __Phising 🎣__, and our source of information is privided by <img src="https://github.com/Brilliant-Labs/code.bl/blob/code_alpha/packaged/docs/static/mb/projects/bboard-tutorials-cyberville/ValuableData/2_Get_Reliable_Information/RedHat.png?raw=true" alt="RedHat" title="RedHat" width="50"/> ![RedHat](https://github.com/Brilliant-Labs/code.bl/blob/code_alpha/packaged/docs/static/mb/projects/bboard-tutorials-cyberville/ValuableData/2_Get_Reliable_Information/RedHat.png?raw=true "RedHat")__The Red Hat Frend__.
## Activity
__*Let's start!!!*__
## __🧑‍🏫 Teachers:__
...
__AP name 📳 :__ `Cyberville #?`      
__Password 🔑:__ `BL_Cybr1 `&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; *(If you are using default one)*
