...
__Pas de mot de passe:__ Ne pressez aucun bouton sur l'écran d'initialisation. [🎬 __*Vidéo*__](https://www.canva.com/design/DAGJhwOPNfA/C7i4j-8NuAyaVB4WW4ZQLg/watch?utm_content=DAGJhwOPNfA&utm_campaign=designshare&utm_medium=link&utm_source=editor). 
...
__4.__ __🧑‍🏫 L'enseignant__ choisira les sources d'information sur l'écran du 📳 module M5, qui affichera le module M5 pour la Mission 2 comme __Chapeau Rouge pour le Phishing__. Les __étudiants__ 🧑‍🎓 peuvent trouver des informations sur la __page Web__ générée par le Point d'accès 📳 dont l'adresse IP 📮 est : 192.168.4.1.
    ...
    ![Hats](https://github.com/Brilliant-Labs/code.bl/blob/code_alpha/packaged/docs/static/mb/projects/bboard-tutorials-cyberville/ValuableData/2_Get_Reliable_Information/M2_0.png?raw=true "Hats")
    ![Hats](https://github.com/Brilliant-Labs/code.bl/blob/code_alpha/packaged/docs/static/mb/projects/bboard-tutorials-cyberville/ValuableData/2_Get_Reliable_Information/arrow.png?raw=true "Hats")
    ![Hats](https://github.com/Brilliant-Labs/code.bl/blob/code_alpha/packaged/docs/static/mb/projects/bboard-tutorials-cyberville/ValuableData/2_Get_Reliable_Information/M2A.png?raw=true "Hats")
## __🧑‍🎓 Étudiants:__
...
__4.__ Modifiez le code pour fournir le __ratio__ correct de __🧪 Chlore__ et __🧪 Fluorure__ à l'usine de traitement de l'eau, puis envoyez le nouveau ratio au point d'accès pour sauver l'usine de traitement des eaux de __Cyberville__ ! Consultez le code d'exemple ci-dessous. 
...
![Red1](https://github.com/Brilliant-Labs/code.bl/blob/code_alpha/packaged/docs/static/mb/projects/bboard-tutorials-cyberville/ValuableData/Webs_png/Web_Red1_FR.png?raw=true "Red1")
![Red2](https://github.com/Brilliant-Labs/code.bl/blob/code_alpha/packaged/docs/static/mb/projects/bboard-tutorials-cyberville/ValuableData/Webs_png/Web_Red2_FR.png?raw=true "Red2")
![Red3](https://github.com/Brilliant-Labs/code.bl/blob/code_alpha/packaged/docs/static/mb/projects/bboard-tutorials-cyberville/ValuableData/Webs_png/Web_Red3_FR.png?raw=true "Red3")
![Red4](https://github.com/Brilliant-Labs/code.bl/blob/code_alpha/packaged/docs/static/mb/projects/bboard-tutorials-cyberville/ValuableData/Webs_png/Web_Red4_FR.png?raw=true "Red4")
---
---