...
Welcome to __Mission 3!__ In this mission, you'll learn the three main principles of cybersecurity, called the __CIA Triad!__ The CIA Triad stands for __*Confidentiality, Integrity, and Availability*__. These three pillars are the foundation of keeping information safe. They are all equally important—if one fails, the whole system can be at risk! Let’s dive in and learn how to protect information like a true cybersecurity hero in the __Cyberville__.
