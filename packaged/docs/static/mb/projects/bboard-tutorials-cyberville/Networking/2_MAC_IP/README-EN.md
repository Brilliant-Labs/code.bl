...
### 34:ab:95:98:d1
The MAC Address 🆔 is unique; every computer, phone, tablet, b.Board, or electronic device connected to any network has its own MAC address 🆔.
...
The M5 module will assign an IP address 📮 to each b.Board in Cyberville, as it will serve as our access point 📳.
...
___1.__ Go to 'https://code-alpha.brilliantlabs.ca/' and create a new project or use the Cyber_Network project created in the previous activity.
...
__5.__ Replace the “Hello!” text in the 🧩[show string] block with the 🧩[Get the b.Board´s IP Address] block. This is located under "b.Board blocks" in "CyberSecurity".
