...
- 2️⃣ 🧑‍🏫 Teachers, there are three different ways to set up passwords on the M5 module. Once the password is set, the 🧑‍🏫 teacher should share it with the 🧑‍🎓 students.
...
## __``Task #2: Sequence to access``__

- 1️⃣ Choose your role 👤 in __Cyberville__:  
...
![Connected](https://raw.githubusercontent.com/Brilliant-Labs/code.bl/code_alpha/packaged/docs/static/mb/projects/bboard-tutorials-cyberville-full/Passwords/Connected.png?raw=true "Connected")